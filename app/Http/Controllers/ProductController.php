...
class ProductController extends Controller
{
    ...
    public function getDanhSachBanHang()
    {
        $sanpham = DB::table('san_pham')->where('trang_thai','=',1)->orderBy('san_pham.id','desc')->paginate(5);
        $loaisanpham = DB::table('loai_san_pham')->where('trang_thai','=',1)->select('id', 'ten_LSP')->get();
        return view('admin.sanpham-ban-hang.danhsach', compact('sanpham', 'loaisanpham'));
    }

    public function getThemBanHang()
    {
        $loaisanpham = DB::table('loai_san_pham')->where('trang_thai','=',1)->select('id', 'ten_LSP')->get();
        return view('admin.sanpham-ban-hang.them', compact('loaisanpham' ));
    }
    ...
    public function postThemBanHang(Request $request)
    {
        ...
        return redirect('admin/sanpham-ban-hang/them')->with('thongbao', 'Thêm thành công');
    }
    ...
    public function postSuaBanHang(Request $request, $id)
    {
        ...
        return redirect('admin/sanpham-ban-hang/sua/' . $id)->with('thongbao', 'Sửa thành công');
    }
    ...
    public function getDanhSachNhapKho()
    {
        $sanpham = DB::table('san_pham')->where('trang_thai','=',1)->orderBy('san_pham.id','desc')->paginate(5);
        $loaisanpham = DB::table('loai_san_pham')->where('trang_thai','=',1)->select('id', 'ten_LSP')->get();
        return view('admin.sanpham-nhap-kho.danhsach', compact('sanpham', 'loaisanpham'));
    }

    public function getThemNhapKho()
    {
        $loaisanpham = DB::table('loai_san_pham')->where('trang_thai','=',1)->select('id', 'ten_LSP')->get();
        return view('admin.sanpham-nhap-kho.them', compact('loaisanpham' ));
    }
    ...
    public function postThemNhapKho(Request $request)
    {
        ...
        return redirect('admin/sanpham-nhap-kho/them')->with('thongbao', 'Thêm thành công');
    }
