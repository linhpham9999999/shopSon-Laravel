...
class SearchColorProductController extends Controller
{
        ...
        foreach ($data as $dt){
            $output.=
                '<tr class="nk-tb-item">
                    ...
                    '.'</td>
                    <td class="nk-tb-col tb-col-mb">'.'
                    <a href="admin/mausp-ban-hang/sua/'.$dt->id.'">'.'<img src="admin_asset/edit.png" width="30px"/>'.'
                    </a>
                    '.'</td>
                </tr>';
        }
    ...
    public function searchNhapKho(Request $request){
        $output="";
        $product_color = $request->product_color_input;
        $data = DB::table('mau_san_pham')->join('loai_san_pham','mau_san_pham.id_LSP','=','loai_san_pham.id')
            ->join('san_pham','mau_san_pham.id_SP','=','san_pham.id')
        ...
        foreach ($data as $dt){
            $output.=
                '<tr class="nk-tb-item">
                    ...
                    '.'</td>
                    <td class="nk-tb-col tb-col-mb">'.'
                    <a href="admin/mausp-nhap-kho/sua/'.$dt->id.'">'.'<img src="admin_asset/edit.png" width="30px"/>'.'
                    </a>
                    '.'</td>
                </tr>';
        }
