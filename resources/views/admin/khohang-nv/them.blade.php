                                ...
                                <div class="card-title-group">
                                    <div class="card-tools">
                                        <div class="form-inline flex-nowrap gx-3">
                                            ...
                                            <form action="{{route('searchProduct-nhap-kho')}}" method="POST">
                                                {{csrf_field()}}
                                    ...
                                    @foreach($productColor as $data)
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-md">
                                                <a href="{{route('chiTietNhapKho-nhap-kho',['id'=>$data->id])}}" target="_blank" class="btn btn-warning btn-add"><em class="icon ni ni-plus"></em></a>
                                            </div>
                                        </div><!-- .nk-tb-item -->
                                    @endforeach
                                </div>
