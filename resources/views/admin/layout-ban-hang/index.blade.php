...
<div class="nk-app-root">
    ...
    <div class="nk-main ">
        <!-- sidebar @s -->
    @include('admin.layout-ban-hang.menu')
    <!-- sidebar @e -->
        <!-- wrap @s -->
        <div class="nk-wrap ">
            <!-- main header @s -->
        @include('admin.layout-ban-hang.header')
        <!-- main header @e -->
            <!-- content @s -->
            ...
            <!-- content @e -->
            <!-- footer @s -->
        @include('admin.layout-ban-hang.footer')
        <!-- footer @e -->
        </div>
        <!-- wrap @e -->
    </div>
...
<script>
    ...
    $(document).ready(function (){
        $('.js-edit-btn').on('click', function() {
            var id = $(this).data('id');
            $.get('admin/loaisp-ban-hang/sua/' + id, function(lsp){
                $("#id").val(lsp.id);
        ...
        $('.js-btn-update-lsp').on('click',function (e) {
            e.preventDefault();
            $.ajax({
                url: "admin/loaisp-ban-hang/post-sua",
                method: 'post',
                headers: {
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.js-delete-sanpham').on('click', function(e){
            ...
            $.ajax(
                {
                    url: "admin/sanpham-ban-hang/xoa/" + id,
                    method: 'POST',
                    data: {
                        _token: token,
                        id: id
        ...
        $('.js-delete-mausanpham').on('click', function(e){
            ...
            $.ajax(
                {
                    url: "admin/mausp-ban-hang/xoa/" + id,
                    method: 'POST',
                    data: {
                        _token: token,
                        id: id
