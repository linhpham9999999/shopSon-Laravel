<nav class="navbar navbar-default navbar-fixed">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('homeAd')}}">Dashboard</a>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-left">
                <li>
                    <a href="{{route('homeAd')}}" class="dropdown-toggle" data-toggle="dropdown">
...
{{--                </li>--}}
            ...
            <ul class="nav navbar-nav navbar-right">
                <li style="margin-top:10px; padding-top: 8px;"><i class="pe-7s-user"></i></li>
                <li>
                    <a href="{{route('info')}}">
