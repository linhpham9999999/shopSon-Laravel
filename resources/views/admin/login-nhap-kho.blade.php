...
<head>
    ...
    <title>Đăng nhập hệ thống nhập kho</title>
    <base href="{{asset('')}}">
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    <h1 style="color:#FF8000; font-size: 19px; text-align: center"><b>ĐĂNG NHẬP HỆ THỐNG NHẬP KHO</b></h1>
                </div>
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form action="{{route('xy-ly-dang-nhap-nhap-kho')}}" method="POST">
                        {{csrf_field()}}
                        <fieldset>
