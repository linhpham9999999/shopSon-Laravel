        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="padding: 15px 15px">
                    ...
                    <div class="content">
                        <form action="{{route('actionSuaMSP-ban-hang',['id'=>$mausanppham->id])}}" method="POST" role="form" enctype="multipart/form-data" >
                            {{csrf_field()}}
                            ...
                            <a href="{{route('dsMSP-ban-hang')}}" class="btn btn-dark pull-right">Xem Màu sản phẩm</a>
