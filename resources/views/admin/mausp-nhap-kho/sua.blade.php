        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="padding: 15px 15px">
                    ...
                    <div class="content">
                        <form action="{{route('actionSuaMSP-nhap-kho',['id'=>$mausanppham->id])}}" method="POST" role="form" enctype="multipart/form-data" >
                            {{csrf_field()}}
                            ...
                            <a href="{{route('dsMSP-nhap-kho')}}" class="btn btn-dark pull-right">Xem Màu sản phẩm</a>
