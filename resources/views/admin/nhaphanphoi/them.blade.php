    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Thêm thông tin nhà phân phối</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body">
                <form action="" data-url="{{ route('actionThem') }}" id="form-add-npp" method="POST" role="form" class="form-validate is-alter">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label class="form-label" for="full-name">Mã nhà phân phối</label>
                        <div class="form-control-wrap">
                            <input class="form-control" name="idNPP" id="idNPP-add" placeholder="Mã nhà phân phối phải có độ dài từ 3 đến 8 ký tự" required/>
{{--                            <div class="error"> {{$errors->first('idNPP')}}</div>--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input class="form-control" name="tenNPP" id="tenNPP-add" placeholder="Tên nhà phân phối phải có độ dài từ 10 đến 100 ký tự" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="email-address">Địa chỉ</label>
                        <div class="form-control-wrap">
                            <input class="form-control" name="dcNPP" id="dcNPP-add" placeholder="Địa chỉ phải có độ dài từ 10 đến 255 ký tự" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="phone-no">Số điện thoại</label>
                        <div class="form-control-wrap">
                            <input class="form-control" name="sodtNPP" id="sodtNPP-add" placeholder="Số điện thoại phải có độ dài 10 ký tự" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="email-address">Email</label>
                        <div class="form-control-wrap">
                            <input class="form-control" name="emailNPP" id="emailNPP-add" placeholder="Email phải có độ dài từ 10 đến 40 ký tự" required />
                        </div>
                    </div>
                    <div class="form-group">
