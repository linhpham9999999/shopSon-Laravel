                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt">
                                    ...
                                    <a href="{{route('getThemShipper')}}" class="btn btn-primary btn-add"><em class="icon ni ni-plus"></em><span>Thêm</span></a>
                                </li>
                            </ul>
                        </div>
                    </div><!-- .toggle-wrap -->
                            ...
                            @foreach($shipper as $nv)
                                <tr class="nk-tb-item">
                                    ...
                                    <td class="nk-tb-col tb-col-mb">
                                        ...
                                        <a href="admin/shipper/sua/{{$nv->id}}"><img src="admin_asset/edit.png" width="30px"/></a>
                                    </td>
                                </tr><!-- .nk-tb-item -->
                            @endforeach
                            </tbody>
