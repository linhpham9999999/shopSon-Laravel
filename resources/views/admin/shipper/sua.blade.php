        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="padding: 15px 15px">
                    ...
                    <div class="content">
                        <form action="{{route('actionSuaShipper',['id'=>$shipper->id])}}" method="POST" role="form" enctype="multipart/form-data" >
                            {{csrf_field()}}
                            ...
                            <a href="{{route('danhsachShipper')}}" class="btn btn-dark pull-right">Xem Nhân viên</a>
