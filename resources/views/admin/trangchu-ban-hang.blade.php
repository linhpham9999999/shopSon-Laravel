    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="card text-white mb-4 home-hover" style="background-color: steelblue;">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" href="{{route('dsLSP-ban-hang')}}">Quản lý</a>
        ...
        <div class="col-xl-3">
            <div class="card text-white mb-4 home-hover" style="background-color: steelblue;">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" href="{{route('dsSP-ban-hang')}}">Quản lý</a>
                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3">
            <div class="card text-white mb-4" style="background-color: steelblue;">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" href="{{route('dsMSP-ban-hang')}}">Quản lý</a>
                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                </div>
            </div>
        </div>
