...
@section('content')
    <div class="nk-content-body" style="background-color: coral; width: auto">
        <div class="content-page wide-md m-auto">
            <div class="nk-block">
                <div class="card card-bordered">
                    <div class="card-inner">
                        <h4 class="title text-soft mb-4 overline-title">Đây là email tự động. Qúy khách hàng vui lòng không trả lời email này</h4>
                            ...
                            <tr>
                                <td class="py-5">
                                    ...
                                    <div class="col-md-12" style="margin: 20px 40px;">
                                        <h3 class="email-heading email-heading-s1 mb-4">Chào bạn {{$shipping_array['customer_name']}}, Bạn đã đặt hàng thành công</h3>
